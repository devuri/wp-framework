...
namespace WPframework\Tests\Unit\Component\Middleware\Support;
 ...
 * @internal
 *
 * @covers \WPframework\Middleware\Support\SiteManager
 */
class SiteManagerTest extends TestCase
{
    ...
    {
        $this->configManager = new AppConfig(new ConstantBuilder());
        $this->siteConstant = new SiteManager($this->configManager);
    }
    ...
    public function test_set_environment(): void
    {
        ...
        $this->siteConstant->setEnvironment('staging');
