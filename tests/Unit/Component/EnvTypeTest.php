...
class EnvTypeTest extends TestCase
{
    ...
    public function test_filter_files_removes_non_existing_files(): void
    {
        ...
        $filteredFiles = EnvType::filterFiles($envFiles, $this->appPath);
    ...
    public function test_rand_str_includes_special_characters_when_requested(): void
    {
        $password = EnvType::randStr(12, true);
