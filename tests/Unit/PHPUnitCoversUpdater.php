...
class PHPUnitCoversUpdater
{
     ...
     */
    public function updateCoversAnnotations(): void
    {
     ...
     */
    protected function processTestFile($filePath): void
    {
        ...
        foreach ($methods as $method) {
            if (0 === strpos($method->getName(), 'test')) {
     ...
     */
    protected function addCoversAnnotation(ReflectionMethod $method, &$fileContent, $filePath): void
    {
        ...
        if ($docComment && false === strpos($docComment, '@covers')) {
     ...
     *
     * @return null|string The class name or null if it cannot be determined.
     */
